...
parser.add_argument('-msp', '--memory_samples', help='Number of Samples to Include in a Memory Sample', nargs='?', default=8, type=int)
...
file.write("Memory Samples: " + str(args.memory_samples) + '\n')
...
def print_args():
    ...
    print ' Memory Samples:', args.memory_samples
